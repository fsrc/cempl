...
(function() {
  var elements, ensureMarkupArguments, markup, unwrapFunctionToString, _,
    __slice = [].slice;
  ...
  markup = function(registeredFunctions, intag, inattr, incontent) {
    ...
    return (function(tag, attr, f, text) {
      var all, children, ex, outer, tagfn, wrapper;
      children = [];
      ...
      tagfn = function() {
        ...
        children.push(markup.apply(null, [registeredFunctions].concat(__slice.call(args))));
        return wrapper;
      };
      ...
      wrapper = {
        ...
        apply: function() {
          ...
          if (f == null) {
            return console.log("Warning, tried to apply subnodes in tag " + tag);
          } else {
